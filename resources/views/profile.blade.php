                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <img th:src="${profile_photo!=null} ? ${profile_photo} : @{/images/man.png}  "
                                    alt="Profile_Image" class="rounded-circle" width="150">
                                <div class="mt-3">
                                    <h4>
                      ...
                      <button class="btn btn-outline-primary">Message</button> -->
                                    ...
                                    <div class="upload-profile-photo">
                                        <form th:action="@{/upload-profile-photo}" method="post"
                    ...
                    <div class="col-sm-9 text-secondary">
                      (320) 380-4539
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a class="btn btn-info " target="_self" id="change_password"
                                        onclick="openpost()">Change Password</a>
                                </div>
                            </div>
                        </div>
                    </div>
